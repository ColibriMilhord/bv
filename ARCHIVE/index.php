...
<body class="loading">
    ...
    <section id="experience">
        ...
        <div class="experience-grid">
            <div class="exp-text-block">
                <p
                    style="margin-bottom: 20px; color: #555; font-style: italic; border-left: 3px solid var(--gold-text); padding-left: 15px;">
                    "Avant d'être cette villa 5 étoiles, cette maison était le cœur battant de ma famille, une ferme
                    vigneronne ancrée dans la roche de Sainte-Eulalie-d'Olt."
                </p>

                <p style="margin-bottom: 15px; color: #555;">
                    <strong>L'Intelligence du lieu :</strong> Mes grands-parents ont choisi cet emplacement dominant la
                    vallée pour une raison précise : offrir à leurs vignes l'exposition la plus généreuse. Aujourd'hui,
                    ce microclimat privilégié est devenu le gardien de vos vacances, garantissant un ensoleillement
                    unique du matin au soir sur la piscine.
                </p>

                <p style="margin-bottom: 15px; color: #555;">
                    <strong>Des racines et des ailes :</strong> Rénover ce bâtiment était une promesse. Nous avons
                    conservé les murs épais en <em>galets du Lot</em>, façonnés par la rivière, et la toiture
                    traditionnelle en lauze qui protège la maison depuis des décennies. À l'intérieur, le confort
                    contemporain dialogue avec cette histoire pour offrir un luxe authentique, sans artifice.
                </p>

                <p style="margin-bottom: 20px; color: #555;">
                    <strong>De notre famille à la vôtre :</strong> Le parc de 5000 m², autrefois terre de labeur, est
                    devenu un sanctuaire de liberté pour vos enfants et un havre de paix pour les amoureux de nature. En
                    séjournant ici, vous n'êtes pas de simples touristes, mais les dépositaires, le temps d'un séjour,
                    de la douceur de vivre de Bellevue.
                </p>
            ...
            <div class="villa-visual">
                <?php
                // --- DIAPORAMA FAMILLE (images/BELLEVUE) ---
                    ...
                    <div class="family-slideshow" id="familySlideshow">
                        <?php foreach ($famille_images as $index => $img): ?>
                            <img src="<?php echo $img; ?>" 
                                 alt="La Villa Bellevue" 
                                 class="family-slide <?php echo ($index === 0) ? 'active' : ''; ?>">
                        <?php endforeach; ?>
                        <!-- Cadre décoratif identique au PMR -->
    ...
    <section id="accessibilite" class="access-section">
        ...
        // 1. Essai de détection automatique
        $pmr_images = [];
        ...
        foreach ($extensions as $ext) {
            ...
            if ($found) {
                $pmr_images = array_merge($pmr_images, $found);
            }
        }
        ...
        <div class="access-container">
            ...
            <div class="access-visual-side">
                ...
                <?php else: ?>
                    <div class="access-icon-wrapper error-mode">
                        ...
                        <div
                            style="width:100%; height:300px; background:#f0f0f0; display:flex; align-items:center; justify-content:center; flex-direction:column; border:1px solid #ccc;">
                            <span style="font-size: 50px; color:#ccc;">accessible</span>
            ...
            <div class="access-content">
                ...
                <p class="access-intro">
                    Pour des vacances en toute tranquillité, nous avons conçu Bellevue d'Aveyron comme un espace ouvert
                    à tous. L'accessibilité n'est pas une option, c'est une promesse de sérénité partagée.
                </p>

                <div class="access-features">
                    <div class="access-item">
                        <span class="check-gold">✓</span>
                        <p><strong>Plain-pied intégral :</strong> Du parking aux espaces de vie (cuisine, salon,
                            terrasses), tout est pensé pour une circulation fluide sans obstacle.</p>
                    </div>
                    <div class="access-item">
                        <span class="check-gold">✓</span>
                        <p><strong>Espace nuit adapté :</strong> Une chambre et une salle de bain entièrement équipées
                            sont accessibles directement au rez-de-chaussée.</p>
                    </div>
                    <div class="access-item">
                        <span class="check-gold">✓</span>
                        <p><strong>Aménagements extérieurs :</strong> Une piste aménagée relie le parking à la maison
                            pour un accès facilité en toutes circonstances.</p>
                    </div>
                </div>

                <p class="access-footer">
                    Idéalement situé pour visiter les merveilles accessibles de la région (Beaux villages, Viaduc de
                    Millau, Musée Soulages...).
        ...
        <div class="pricing-container">
            ...
            <?php else: ?>
                <?php foreach ($tarifs_display as $t):
                    $isHigh = $t['prix_semaine'] > 2000; // Logique simple pour highlight
    ...
    <section id="temoignages" class="reviews-section">
        <div class="section-header">
            <span class="subtitle">L'Excellence Reconnue</span>
            <h2>Paroles d'Hôtes</h2>
        </div>
        ...
        <div class="reviews-grid">
            <div class="review-card">
                ...
                <p class="review-text">
                    "Si vous savez ce que qualité veut dire, alors Bellevue d'Aveyron est la bonne destination. Un gîte
                    d'exception qui porte bien son nom. Le moderne est très bien marié avec l'ancien."
                </p>
                <div class="review-author">Famille D. &bull; Juillet 2024</div>
            </div>

            <div class="review-card featured">
                <div class="review-quote-icon">”</div>
                <p class="review-text">
                    "Calme et Sérénité sont les maîtres-mots. Une vue à couper le souffle et une maison où tout est
                    pensé pour le confort absolu. Les 5 étoiles sont amplement méritées."
                </p>
                <div class="review-author">Sylvia C. &bull; Séjour Ressourçant</div>
            </div>

            <div class="review-card">
                <div class="review-stars">★★★★★</div>
                <p class="review-text">
                    "Un propriétaire passionné. Dans cet écrin de verdure, tous les ingrédients sont réunis : liberté,
                    confort et bonheur. Une rénovation de très grand goût."
                </p>
                <div class="review-author">Jacky L. &bull; Vacances en Famille</div>
            </div>
        </div>
    ...
    <div class="modal-overlay <?php echo $bookingSuccess ? 'active' : ''; ?>" id="successModal">
        <div class="modal-card">
            ...
            <p style="color:#666; margin-bottom:20px;">
                ...
                Votre demande pour
                <?php echo isset($bookingData['nuits']) ? $bookingData['nuits'] : ''; ?> nuits a bien été enregistrée.
                <br><br>
    ...
    <script>
        ...
        function initFamilySlideshow() {
            ...
            setInterval(() => {
                ...
                currentIndex = (currentIndex + 1) % slides.length;
                slides[currentIndex].classList.add('active');
            }, 5000); // 5 secondes pour décalage avec l'autre
        }
